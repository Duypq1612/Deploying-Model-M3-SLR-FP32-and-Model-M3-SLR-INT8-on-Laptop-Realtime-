...
class FlashAttention(nn.Module):
    """
    Phiên bản self-attention chuẩn (KHÔNG dùng flash_attn),
    tương thích với API cũ để Uniformer hoạt động bình thường trên CPU.
    """
    ...
    def forward(self, x):
        ...
        # tách thành q, k, v: [B, num_heads, N, head_dim]
...
# Định nghĩa Attention dùng chung cho SplitSABlock
class Attention(FlashAttention):
    pass
